  ...
  return (
    <div className="h-full flex flex-col justify-between">
      <div className="mb-10">
        ...
        <motion.div
          className="w-12/12 mx-auto mt-7 "
          initial={{ y: 100, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ type: "spring", stiffness: 120, damping: 14 }}
        >
          <div className=" w-11/12 mx-auto my-0 h-[750px]">
            <p className="fontBold text-[70px] text-[#17202A] text-center">
              <b>No Pain, No Strain with our Tai Chi program</b>
            </p>

            <ul className="text-[45px] list-disc list-inside mt-5 text-[#7E7F80] fontRegular">
              {[
                "Strengthens muscles",
