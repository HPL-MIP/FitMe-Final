    ...
    useEffect(() => {
        if (typeof window.ALPlayableAnalytics !== "undefined") {
            window.ALPlayableAnalytics.trackEvent("CUSTOM", {
                ...
                question: "After a week or two of eating healthier or exercising, I tend to fall back into my old routine",
            });
        }
    }, []);
        ...
        >
            <div className="px-[50px] pt-[50px] pb-[30px] mt-8">
                ...
                <h1
                    ...
                    style={{ fontSize: "65px", lineHeight: "90px" }}
                >
                    "After a week or two of eating healthier or exercising, I tend to fall back into my old routine"
                </h1>
