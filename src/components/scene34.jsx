...
import overweight_bmi from "../assets/img/overweight_bmi.png";
...
const Scene34 = ({ onNext }) => {
  ...
  const showError = touched && email.length > 0 && !canSubmit;
  ...
  return (
    ...
    >
      <div className="px-[50px] pt-[60px] pb-[30px] flex flex-col">
        ...
        <div className="relative w-full">
          <input
            ...
            style={{
              ...
              height: "160px",
              borderRadius: "44px",
              border: showError ? "3px solid #FF3B30" : "3px solid #CACACA",
              fontSize: "43px",
        ...
        {showError && (
          <p
            className="mt-[20px] ml-10 text-red-500 flex items-center"
            style={{
              fontSize: "40px",
              lineHeight: "44px",
          ...
          >
            <img src={overweight_bmi} alt="overweight_bmi" className="mr-4" />{" "}
